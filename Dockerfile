...
RUN wget --no-check-certificate \
      https://install.service-now.com/glide/distribution/builds/package/mid/2018/05/24/mid.kingston-10-17-2017__patch6-05-16-2018_05-24-2018_1317.linux.x86-32.zip \
      -O /tmp/mid.zip && \
